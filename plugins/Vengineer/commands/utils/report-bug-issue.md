...
# Report a Vengineer Plugin Bug

Report bugs encountered while using the Vengineer plugin. This command gathers structured information and creates a GitHub issue for the maintainer.
