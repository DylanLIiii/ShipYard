...
description: Comprehensive code review specialist covering 5 focused aspects - architecture & design, code quality, security & dependencies, performance & scalability, and documentation & API design. Provides deep analysis with actionable feedback. Use PROACTIVELY after significant code changes.
...
This agent can be invoked for any of these 5 specialized review aspects:
...
5. **Documentation & API** - README, API docs, breaking changes, developer experience
