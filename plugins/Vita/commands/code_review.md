...
2. Launch only relevant review agents:
   ...
   - **Source code files** (*.ts, *.js, *.py, etc.): Launch all 5 review agents
   - **Mixed changes**: Launch agents relevant to each file type present

If reviewing a specific directory or broad scope:
- Launch all 5 review agents for comprehensive coverage
...
Focus: Architecture, Security, Performance, Documentation
...
🔒 Security | 🏗️ Architecture | ⚡ Performance | 📝 Documentation | 💥 Breaking Change